            ...
            <div class="contentbox">
                <div class="logo">
                    <button v-on:click="goToPage('/main')">
                        <img src="/images/logo.png" alt="이지퍼블리싱 로고">
                    </button>
                </div>
                <div class="system">
            ...
            <div class="contentbox">
                <ul>
                    <li v-for="(item, index) in menulists" :key="index">
                        <button v-html="item.menutext" v-on:click="goToPage(item.link)"></button>
                    </li>
                </ul>
            </div>
        </nav>
        <b-modal id="login" class="modal" hide-footer>
            ...
            <div class="modalcontainer">
                <div class="loginform">
                    ...
                    <b-form-input type="password" id="password" placeholder="비밀번호를 입력해주세요."></b-form-input>
                </div>
                <div class="btnwrap">
